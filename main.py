...
def draw_l_system_callback(sender, app_data, user_data):
    ...
    try: 
        ...
        start_x = 500
        start_y = 600
        lines_data = interpret_l_system(l_system_string, angle, length, (start_x, start_y), Fluctuation=is_fluctuation)
    ...
    with dpg.window(tag="Primary Window", label="L-System Drawer", width=1050, height=900):
        with dpg.group(horizontal=True):
         ...
         with dpg.child_window(width=300, height=200):   
            ...
            dpg.add_text("(Randomizes plant structure)", color=[150, 150, 150], wrap=280)
